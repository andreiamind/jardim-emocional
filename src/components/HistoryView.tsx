...
import { History, PieChart, Tag, Sparkles, Loader2, Sprout, Flower, Flower2 } from 'lucide-react';
    ...
    >
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] font-bold text-slate-400 uppercase">Últimos 5 dias • {panoramaData.totalCount} Entradas</span>
        </div>
        ...
        <div className="bg-emerald-50/40 border border-emerald-100/50 rounded-[2.5rem] p-10 min-h-[280px] relative overflow-hidden shadow-inner flex flex-wrap items-end justify-center gap-x-8 gap-y-12">
          ...
          {panoramaData.distribution.length === 0 ? (
            ...
            panoramaData.distribution.map((m, idx) => {
              let Icon = Sprout;
              let size = 24;
              let scale = 1;
              let label = "Broto";
